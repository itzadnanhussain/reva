                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-5 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <form class="pt-3">
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" onclick="login()">Login</a>
                                </div>
                                <div class="mt-3">
                                    <button type="submit" class="btn btn-block btn-orange btn-lg font-weight-medium auth-form-btn" onclick="register()">Register</a>
                                </div>
