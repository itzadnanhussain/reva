...
!(function () {
		...
		cr = function (e, t, n) {
			...
			if (((n = n || e), t)) {
				if (
					...
					"static" === nr(Tt.fromDom(e), "position")
				)
					return {
						x: (a =
			...
			var p = 0,
							...
							(2 !== i.status
								? 3 !== i.status
									? ((i.status = 1),
									  ...
									  g.referrerPolicy &&
											Gn(a, "referrerpolicy", g.referrerPolicy),
									  ((r = a.dom).onload = d),
									  (r.onerror = f),
									  (s = a),
									  mn(un(v), s),
				...
				t = function (e) {
					...
					he(h, r).each(function (e) {
						var t, n;
						0 == --e.count &&
							(delete h[r], (t = e.id), (n = un(v)), Lr(n, "#" + t).each(hn));
					});
				};
			return {
				load: n,
	...
	var Qr,
		...
		bo = function (e) {
			return (
				yo(e) && (e = e.parentNode), vo(e) && e.hasAttribute("data-mce-caret")
			);
		},
		Co = function (e) {
		...
		So = function (e) {
			...
			return (
				!!Fn(t) &&
				(t.data.charAt(e.offset()) === go ||
					(e.isAtStart() && Co(t.previousSibling)))
			);
		},
		No = function (e) {
			var t = e.container();
			return (
				!!Fn(t) &&
				(t.data.charAt(e.offset() - 1) === go ||
					(e.isAtEnd() && Co(t.nextSibling)))
			);
		},
		Eo = function (e, t, n) {
			var r,
		...
		Mo = function (e) {
			return (
				!Io(e) && (Oo(e) ? !Bo(e.parentNode) : Po(e) || Do(e) || Lo(e) || Fo(e))
			);
		},
		Fo = function (e) {
			return (
				!1 === (Tn((t = e)) && "true" === t.getAttribute("unselectable")) &&
				To(e)
			);
			var t;
		},
		...
		Vo = function (e, t) {
			return (
				(Mo(e) &&
					!1 === ((o = t), Fn((r = e)) && jo(r.data) && !1 === Ho(r, o))) ||
				(Tn((n = e)) &&
					"A" === n.nodeName &&
					!n.hasAttribute("href") &&
		...
		wi = function (i) {
			...
			i.valid_elements
				...
				: (pi(p, function (e, t) {
				  ...
				  pi(
						bi("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
						function (e) {
							S[e].paddEmpty = !0;
						}
				  ),
	...
	var Da = function (e, t, n, r) {
		...
		if (
			((t ? t.ownerDocument || t : Ji) !== qi && Vi(t),
			(n = n || []),
			!e || "string" != typeof e)
		)
			return n;
	...
	function Oa() {
		...
		function r(e, t) {
			return (
				n.push(e + " ") > Pi.cacheLength && delete r[n.shift()],
				(r[e + " "] = t)
			);
		}
		return r;
	...
	(Bi = Da.support = {}),
		...
		(Da.attr = function (e, t) {
			...
			var n = Pi.attrHandle[t.toLowerCase()],
				r =
					n && ia.call(Pi.attrHandle, t.toLowerCase())
						? n(e, t, !Wi)
						: undefined;
			return r !== undefined
				? r
						...
						(a = (function f(e) {
							for (
								...
								if ((t = Pi.relative[e[u].type])) l = [Ua(za(l), t)];
									...
									if (
										(t = Pi.filter[e[u].type].apply(null, e[u].matches))[Gi]
									) {
				...
				if (((n = n || []), 1 === l.length)) {
					...
					for (
						...
						if (
							(s = Pi.find[u]) &&
							(r = s(
								a.matches[0].replace(Ra, Ta),
								(_a.test(i[0].type) && Ia(t.parentNode)) || t
							))
						) {
							if ((i.splice(o, 1), !(e = r.length && Fa(i))))
								return ca.apply(n, r), n;
							break;
						}
				}
				return (
					(c || Fi(e, l))(r, t, !Wi, n, (_a.test(e) && Ia(t.parentNode)) || t),
					n
				);
			}),
	...
	var Lu = function (n, r) {
		...
		ds = function (e, t) {
			...
			return (
				e.bottom - n < t.top ||
				(!(e.top > t.bottom) && fs(t.top - e.bottom, e, t))
			);
		},
		ms = function (e, t) {
			return (
				e.top > t.bottom || (!(e.bottom < t.top) && fs(t.bottom - e.top, e, t))
			);
		},
		gs = function (e, t, n) {
			...
			var t,
				...
				i = function (e, t) {
					...
					if (t < e.data.length) {
						...
						if (
							ys(e.data[t - 1]) &&
							(n.setStart(e, t), n.setEnd(e, t + 1), !Os(n))
						)
							return o(Ls(Ps(n), !1)), r;
					}
					0 < t &&
						(n.setStart(e, t - 1), n.setEnd(e, t), Os(n) || o(Ls(Ps(n), !1))),
						t < e.data.length &&
							(n.setStart(e, t), n.setEnd(e, t + 1), Os(n) || o(Ls(Ps(n), !0)));
				};
	...
	var Fs,
			...
			return i
				? Hs(i)
					? (function (e, t) {
							...
							return (
								Hs(e) && t > e.data.length && (t = e.data.length), Ms(e, t)
							);
					  })(i, parseInt(o, 10))
		...
		nc = function (e, t) {
			...
			if (wo(e)) {
				if (
					(Fn(e) && bo(e) && (e = e.parentNode), (n = e.previousSibling), Js(n))
				)
					return n;
	...
	var fl,
		...
		Rl = function (e, t, n) {
			return e
				? !Al(t, n) &&
						((r = t), !(!Ms.isTextPosition(r) && Hn(r.getNode()))) &&
						_l(t) &&
						kl(n)
				: !Al(n, t) && kl(t) && _l(n);
			var r;
		...
		Af = function (e, t, n, r) {
			var o = n.parentNode;
			return (
				!V(n[r]) && (!(o !== t && !X(o) && !e.isBlock(o)) || Af(e, t, o, r))
			);
		},
		...
		$f =
			...
			(ml = "text"),
			{
				get: function (e) {
					if (!dl(e))
						throw new Error(
							"Can only get " + ml + " value of a " + ml + " node"
						);
					return gl(e).getOr("");
				},
				...
				set: function (e, t) {
					if (!dl(e))
						throw new Error(
							"Can only set raw " + ml + " value of a " + ml + " node"
						);
					e.dom.nodeValue = t;
				},
			}),
	...
	var Zf = function (e, t) {
		...
		dd = function (e, t, n, r) {
			...
			if (
				(Tn(l) && f > l.childNodes.length - 1 && (g = !1),
				zn(l) && ((l = s), (f = 0)),
				l === s)
			) {
	...
	var vd,
		...
		xd =
			...
			}),
			{
				set: function (e, t) {
					if (!N(t) && !t.match(/^[0-9]+$/))
						throw new Error(
							vd + ".set accepts only positive integer values. Value was " + t
						);
					var n = e.dom;
		...
		Md = function (e, t, n, r) {
			...
			i.top < a.y
				? En(n.element, !1 !== r)
				: i.top > a.bottom && En(n.element, !0 === r);
		},
		Fd = function (e, t, n) {
			return Rd(e, Id, t, n);
		},
		...
		Qd = function (e) {
			return Yd.range(
				e.start,
				Jd(e.soffset, e.start),
				e.finish,
				Jd(e.foffset, e.finish)
			);
		},
		Zd = function (e, t) {
		...
		gm = function (t, e) {
			return (
				(n = e).collapsed
					? U.from(hs(n.startContainer, n.startOffset)).map(Tt.fromDom)
					: U.none()
			).bind(function (e) {
	...
	var Wm,
		...
		tg = function (e) {
			...
			return (
				Fn(t) &&
				(0 === t.data.length || (po(t.data) && Qf.isBookmarkNode(t.parentNode)))
			);
		},
		ng = function (t, n) {
			return function (e) {
		...
		og = function (e) {
			return (
				$n(e) && !(Tn((t = e)) && "all" === t.getAttribute("data-mce-bogus"))
			);
			var t;
		},
		ig = ng(!0, rg),
		...
		Tg = function (e, t) {
			return (
				(n = t),
				U.from(n.getNode(!0)).map(Tt.fromDom).exists(oo) ||
					Ag(!1, e, t).isSome()
			);
			var n;
		},
		...
		Qg = function (e) {
			return Mo(e.previousSibling)
				? U.some(
						((t = e.previousSibling),
						Fn(t) ? Ms(t, t.data.length) : Ms.after(t))
				  )
				: e.previousSibling
		...
		Cp = function (n) {
			return us(
				yp((r = n).cells, r.rng.start),
				yp(r.cells, r.rng.end),
				function (e, t) {
		...
		zp = function (e) {
			return 0 < e.length && (!(t = e[e.length - 1]).firstChild || Up(t))
				? e.slice(0, -1)
				: e;
			var t;
		},
		...
		Wp = function (e) {
			...
			(r = t),
				(o = n),
				null !== (i = a) &&
				i === r.getParent(o.endContainer, $p) &&
				zf(Tt.fromDom(i), o)
					? Np(e, n, Tt.fromDom(a))
				...
				if ("undefined" == typeof c.length) {
					for (a in c)
						if (c.hasOwnProperty(a)) {
							if (
								((u = "attributes" === r ? e.getAttrib(t, a) : cf(e, t, a)),
								o && !u && !n.exact)
							)
								return;
		...
		xh = function (e, t) {
			return (
				e.schema.getTextInlineElements().hasOwnProperty(Mt(t)) &&
				!Ul(t.dom) &&
				!Pn(t.dom)
			);
		},
	...
	var kh = At.each,
		...
		qh = function (e, r, o, t, i) {
			...
			if ("all" !== r.remove) {
				Ih(r.styles, function (e, t) {
					(e = sf(l, af(e, o), t + "")),
						N(t) && ((t = e), (i = null)),
						(!r.remove_similar && i && !Mh(cf(l, i, t), e)) ||
							l.setStyle(y, t, ""),
						(n = !0);
				}),
					n &&
					...
					Ih(r.attributes, function (e, t) {
						...
						if (
							...
							if (
								...
								"style" === t &&
									Dn(["li"])(y) &&
									"none" === l.getStyle(y, "list-style-type"))
							)
								return (
									y.removeAttribute(t),
									...
									Y(ie(d.childNodes), function (e) {
										rf(f, v, e.nodeName.toLowerCase())
											? g
												? g.appendChild(e)
												: ((g = jh(h, e, v)),
												  h.setAttribs(g, f.settings.forced_root_block_attrs))
											: (g = 0);
									}))
							: h.isBlock(d) &&
							  !h.isBlock(p) &&
		...
		Kh = function (s, c, l, e, f) {
			...
			if (e)
				Zl(e)
					? ((t = u.createRng()).setStartBefore(e), t.setEndAfter(e), r(t))
					: r(e);
				...
				for (
					var o = 0;
					o < d.length && (!d[o].ceFalseOverride || !$h(s, d[o], l, e, e));
					o++
				);
			}
		},
								...
								s = function (e) {
										...
										Hn(e) &&
											!(function (e, t, n, r) {
												if (
													...
													return (
														ye(o, r) && Ko(Tt.fromDom(n.parentNode), !1) && !i
													);
												}
												return !1;
											})(E, R, e, o))
									...
									if (R.wrapper && uh(E, e, k, _)) u = null;
										...
										if (gf(R)) {
											var a = m(A, e);
											if (
												(Fn(e) && hf(S, e.parentNode) && m(A, e.parentNode),
												!Jh(R, "inline") || a)
											)
												return void (u = null);
										}
		...
		Dv = function (e, t) {
			return (
				!(!e || !t) && ((r = t), Rv(e) === Rv(r) || ((n = t), Tv(e) === Tv(n)))
			);
			var n, r;
		},
		Ov = function (e) {
			...
			return {
				undoManager: {
					beforeChange: function (e, t) {
						return (
							(n = f), (r = t), void (Ov(e) && r.set(U.some(uc(n.selection))))
						);
						var n, r;
					},
					...
					transact: function (e, t, n) {
						return (
							(o = n), Pv((r = e), t), r.beforeChange(), r.ignore(o), r.add()
						);
						var r, o;
					},
					ignore: function (e, t) {
				...
				formatter: {
					...
					canApply: function (e) {
						return (function (e, t) {
							...
							if (u)
								for (
									n = e.selection.getStart(), r = ff(s, n), i = u.length - 1;
									0 <= i;
									i--
								) {
					...
					toggle: function (e, t, n) {
						return (
							...
							void (
								!sh(r, o, i, a) || ("toggle" in u[0] && !u[0].toggle) ? Qh : Kh
							)(r, o, i, a)
						);
						var r, o, i, a, u;
					},
				...
				return (
					...
					t.filter(jt).map(function (e) {
						return (
							...
							void (r
								? (Gg(o, i, !1, !r), n.setStart(i, a))
								: (Gg(i, o, !1, !r), n.setEnd(i, a)))
						);
						var t, n, r, o, i, a;
					})
				);
				...
				t
					...
					return (
						...
						void Kt((n = e)).each(function (e) {
							...
							r && Ug(e, Ms(t, 0))
								? Xg(t, 0)
								: !r && zg(e, Ms(t, t.length)) && Yg(t, t.length);
						})
					);
					var n, r;
				});
	...
	var $v,
		...
		Yv = function (u, s, e, c) {
			var l,
				...
				p = function (e, t) {
					...
					if (
						(r = e) &&
						(Kv(r) || (Xv(r.startContainer) && Xv(r.endContainer)))
					) {
						var r,
							o = Kv(e) ? e : null;
						if (o) {
		...
		Jv = function (e, t) {
			...
			t.convert_fonts_to_spans &&
				Gv(e, r, At.explode(t.font_size_legacy_values)),
				(n = r),
							...
							k = Im(
								{
									...
									start: function (e, t, n) {
										...
										if (a) {
											...
											if (
												(S && y[e] && (S = !1), a.removeEmpty && uy(R, m, y, c))
											)
												return (
													(o = c.parent),
											...
											a.paddEmpty &&
												((ay((i = c), "#text") && i.firstChild.value === mo) ||
													uy(R, m, y, c)) &&
												iy(A, u, d, c),
												(c = c.parent);
										}
						...
						: {}),
					{
						...
						external_plugins:
							...
							s && s.external_plugins
								? At.extend({}, s.external_plugins, l)
								: l),
					}
				);
			return Uy(e, m, r, g);
	...
	var nb,
			...
			var n,
				...
				m = function (e, t, n) {
					var r =
						...
						n +
						'"' +
						(n === St.transparentSrc ? ' data-mce-placeholder="1"' : "");
					return (
						(e = d(e, 'src="' + t + '"', r)),
													...
													s.getParam("images_replace_blob_uris", !0, "boolean")
														...
														: e.error &&
														  (e.error.options.remove &&
																(g(i.getAttribute("src"), St.transparentSrc),
																a.push(i)),
														  (n = s),
														  (r = e.error.message),
														  ab(
																n,
																Bu.translate(["Failed to upload image: {0}", r])
														  )),
													{
														element: i,
														status: e.status,
		...
		Rb = function (s) {
			var e,
				...
				d = {
					...
					transact: function (e) {
						return (
							(t = d), (n = l), (r = e), Uv(s).undoManager.transact(t, n, r)
						);
						var t, n, r;
					},
					ignore: function (e) {
		...
		Mb = function (e) {
			return (
				"rtl" === Su.DOM.getStyle(e, "direction", !0) ||
		...
		Zb = function (e, t, n) {
			return (
				Qb(!0, t), Qb(!1, n), Jb(t, n).fold(k(Gb, e, t, n), k(Yb, e, t, n))
			);
		},
		eC = function (e, t, n, r) {
				...
				e
					? function (e) {
							if (kC(e.previousSibling))
								return (
									AC(e.previousSibling) || e.previousSibling.appendData(go),
									e.previousSibling
								);
					...
					: function (e) {
							if (kC(e.nextSibling))
								return (
									_C(e.nextSibling) || e.nextSibling.insertData(0, go),
									e.nextSibling
								);
	...
	var hw = function (o, i, a, e, u, t) {
		...
		_w = function (e, o) {
			return Ne(e, function (e, t) {
				...
				return Ew(o, t) || (!Ew(o, e) && ((r === n && ww(t.node)) || r < n))
					? t
					: e;
			});
		},
		...
		Kw = function (r, o, i, a) {
			...
			r.undoManager.ignore(function () {
				...
				r.selection.setRng(
					...
					WC(s, u, Ms.fromRangeStart(r.selection.getRng()))
						.map(GC)
						.map(Ww(r, o));
			}),
				r.nodeChanged();
							...
							if (
								(function (e, t) {
									if (Fn(t)) {
										...
										if (
											/^\s+$/.test(t.nodeValue) &&
											(!t.nextSibling || mx(e, t.nextSibling))
										)
											return !0;
									}
									return !1;
		...
		hx = function (e, t) {
			var n,
				r =
					((n = e),
					Lr(Tt.fromDom(n.getBody()), "*[data-mce-caret]").fold(
						E(null),
						function (e) {
							return e.dom;
						}
					...
					(u = (function (e, t, n, r, o) {
						...
						if (!g || !lS(d, g)) {
							if (
								((c =
									(g = g || m) === e.getBody() ||
									((l = g) && /^(TD|TH|CAPTION)$/.test(l.nodeName))
				...
				/^(LI|DT|DD)$/.test(c) && f.isEmpty(s)
					...
					: (N && s === a.getBody()) ||
					  ...
					  bo(s)
							...
							? v()
							: h(!0)
							? ((n = s.parentNode.insertBefore(p(), s)),
							  tS(a, cS(s, "HR") ? n : s))
		...
		hS = function (e, t) {
			...
			"LI" !== d || m || (l = f),
				c &&
					...
					!(function (e, t, n) {
						for (
							var r, o = new Gr(t, n), i = e.getNonEmptyElements();
							(r = o.next());
		...
		$S = function (e, t, n) {
			n && !e.get()
				? t.on("NodeChange", VS, !0)
				: !n && e.get() && t.off("NodeChange", VS),
				e.set(n);
		},
		WS = function (o, i) {
			var a;
		...
		QS = function (r) {
			r.on("keydown", function (e) {
				...
				!1 === e.isDefaultPrevented() &&
					((t = r),
					(n = e),
					Bx([{ keyCode: nd.SPACEBAR, action: Ox(JS, t) }], n).each(function (
						e
					) {
						n.preventDefault();
					}));
	...
	var nN = function (e) {
				...
				function (p) {
					return e.on(function (e) {
						var t,
							...
							m,
							g = Math.max(
								Math.abs(p.screenX - e.screenX),
								Math.abs(p.screenY - e.screenY)
							);
						if (!e.dragging && 10 < g) {
							if (
				...
				(n = e).on("drop", function (e) {
					var t =
						"undefined" != typeof e.clientX
							...
							: null;
					(!uN(t) && "false" !== n.dom.getContentEditableParent(t)) ||
						e.preventDefault();
				}),
					...
					((a = function (e) {
						...
						e.isDefaultPrevented() ||
							((t = e.dataTransfer) &&
								...
								(e.preventDefault(),
								"drop" === e.type &&
									ab(i, "Dropped file type is not supported")));
					}),
					(u = function (e) {
						fm(i, e.target) && a(e);
					}),
		...
		bN = function (u) {
			var s,
				...
				C = function (e) {
					...
					return (
						Y(
							$u(Tt.fromDom(u.getBody()), "*[data-mce-selected]"),
							function (e) {
								Pt(o, e) || er(e, i);
							}
						),
							...
							p(e) ||
								((t =
									...
									s.queryCommandSupported("mceInsertClipboardContent")
										? s.execCommand("mceInsertClipboardContent", !1, {
												content: r,
												internal: o,
										  })
		...
		MN = function (e) {
			...
			return e.inline
				? IN(null)
				: ((t = r), (n = BN.create("div")), BN.insertAfter(n, t), IN(n));
		},
		FN = function (e) {
			var t,
				n,
				...
				K(u)
					? ((i.settings.theme = LN(u)),
					  ...
					  i.theme.init &&
							i.theme.init(
								i,
								tb.urls[u] || i.documentBaseUrl.replace(/\/$/, ""),
								i.$
							))
					: (i.theme = {}),
				(s = e),
				...
				? t.getElement() &&
				  ...
				  (a = t.getElement().form || zN.getParent(e, "form")) &&
						...
						t.getParam("hidden_input") &&
							!Mn(t.getElement()) &&
							(zN.insertAfter(
								zN.create("input", { type: "hidden", name: e }),
								e
							),
							(t.hasHiddenInput = !0)),
		...
		GN = function (o) {
			return function (r, e) {
				return U.from(e)
					...
					.filter(zt)
					.bind(function (e) {
						return YN(o, r, e.dom).or(
							((t = o), (n = e.dom), U.from(Su.DOM.getStyle(n, t, !0)))
						);
						var t, n;
					})
					.getOr("");
			...
			(sE.prototype.setupCommands = function (i) {
				...
				this.addCommands({
					...
					FontSize: function (e, t, n) {
						var r, o;
						(o = n),
							(r = i).formatter.toggle("fontsize", { value: tE(r, o) }),
							r.nodeChanged();
					},
					LineHeight: function (e, t, n) {
						var r, o;
						(o = n),
							(r = i).formatter.toggle("lineheight", { value: String(o) }),
							r.nodeChanged();
					},
	...
	var CE,
		...
		NE = function (e, t) {
			...
			var n = Cc(e);
			return n
				? (e.eventRoot || (e.eventRoot = SE.select(n)[0]), e.eventRoot)
				: e.getBody();
		},
		EE = function (e, t, n) {
			var r;
			...
			toggleNativeEvent: function (e, t) {
				...
				"focus" !== e &&
					...
					(t
						...
						: n.initialized &&
						  (n.dom.unbind(NE(n, e), e, n.delegates[e]),
	...
	var $E = Su.DOM,
		...
		GE =
			...
			(JE.prototype.resetContent = function (e) {
				e === undefined
					? wy(this, this.startContent, { format: "raw" })
					: wy(this, e),
			...
			(JE.prototype.getElement = function () {
				return (
					this.targetElm || (this.targetElm = $E.get(this.id)), this.targetElm
				);
			}),
	...
	function JE(e, t, n) {
		...
		(this.plugins = {}),
			...
			this.settings.referrer_policy &&
				...
				Su.DOM.styleSheetLoader._setReferrerPolicy(
					this.settings.referrer_policy
				)),
	...
	var QE,
		...
		sk = function (e) {
			e !== ok &&
				(e
					? hu(window).on("resize scroll", uk)
					: hu(window).off("resize scroll", uk),
				(ok = e));
		},
		ck = function (t) {
			var e = ak;
			...
			return (
				...
				fk.activeEditor === t &&
					(fk.activeEditor = 0 < ak.length ? ak[0] : null),
		...
		fk = _e(_e({}, xE), {
							...
							r.types
								? tk(r.types, function (t) {
										At.each(o, function (e) {
											return (
												!ZE.is(e, t.selector) || (n(c(e), nk({}, r, t), e), !1)
											);
										});
								  })
								: (At.each(o, function (e) {
			...
			add: function (e) {
				...
				return (
					ik[e.id] === e ||
						(null === n.get(e.id) &&
							("length" !== e.id && (ik[e.id] = e), ik.push(e), ak.push(e)),
						sk(!0),
						(n.activeEditor = e),
	...
	var dk,
		...
		xk =
			...
			(mk = {}),
			{
				...
				add: function (e, t) {
					mk[e] !== undefined && (mk[e](t), delete mk[e]),
						(dk[e] = Mr.resolve(t));
				},
			}),
		Sk = At.each,
			...
			util: {
				...
				ImageUploader: function (n) {
					...
					return {
						upload: function (e, t) {
							return (
								void 0 === t && (t = !0), r.upload(e, t ? yb(n) : undefined)
							);
						},
					};
				},
